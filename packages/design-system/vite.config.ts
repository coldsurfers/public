  ...
  build: {
    ...
    lib: {
      entry: {
        ...
        'native-AnimatedTabBar': 'src/native/AnimatedTabBar.tsx',
        ...
        'native-PullToRefresh': 'src/native/PullToRefresh.tsx',
        'native-Skeleton': 'src/native/Skeleton.tsx',
        'native-Spinner': 'src/native/Spinner.tsx',
        'native-TabBar': 'src/native/TabBar.tsx',
    ...
    rollupOptions: {
      external: [
        ...
        'react/jsx-runtime',
        'react-native',
        // RN 표면(PullToRefresh·TabBar)이 무는 것들. 전부 optional peer 라 소비처가 이미 들고 있다.

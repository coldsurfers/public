...
export type GetPosterDetailByPosterIdParamsDTO = z.infer<
  typeof GetPosterDetailByPosterIdParamsDTOSchema
>

export const CreatePosterBodyDTOSchema = z.object({
  keyId: z.string(),
})
export type CreatePosterBodyDTO = z.infer<typeof CreatePosterBodyDTOSchema>

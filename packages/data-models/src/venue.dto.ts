...
export const GetVenuesQueryStringDTOSchema = OffsetPaginationDTOSchema.extend({
  locationCityName: z.string().optional(),
})
export type GetVenuesQueryStringDTO = z.infer<typeof GetVenuesQueryStringDTOSchema>

export const SearchPartnerVenuesQueryStringDTOSchema = z.object({
  keyword: z.string().min(1),
})
export type SearchPartnerVenuesQueryStringDTO = z.infer<
  typeof SearchPartnerVenuesQueryStringDTOSchema
>

import { z } from 'zod'
import { RecentlyViewedConcertDTOSchema } from './recently-viewed-concert.dto'
...
export const AnonymousUserDTOSchema = z.object({
  ...
  recentlyViewedConcerts: z.array(RecentlyViewedConcertDTOSchema).optional(),
})
export type AnonymousUserDTO = z.infer<typeof AnonymousUserDTOSchema>

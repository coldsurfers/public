...
export const PartnerTypeDTOSchema = z.union([
  z.literal('VENUE'),
  z.literal('ORGANIZER'),
  z.literal('ARTIST'),
])
export type PartnerTypeDTO = z.infer<typeof PartnerTypeDTOSchema>

export const PartnerDTOSchema = z.object({
  id: z.string(),
  type: PartnerTypeDTOSchema,
  isVerified: z.boolean(),
})
export type PartnerDTO = z.infer<typeof PartnerDTOSchema>

export const CreatePartnerBodyDTOSchema = z.object({
  type: PartnerTypeDTOSchema,
})
export type CreatePartnerBodyDTO = z.infer<typeof CreatePartnerBodyDTOSchema>
